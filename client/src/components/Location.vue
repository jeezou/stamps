...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {name:'volume', title: 'Том'},
        {name:'page', title: 'Страница'},
        {name:'position', title: 'Положение на странице'}
      ],
      tableData: [],
      theme: null
    }
  ...
  methods: {
    ...
    update_table: function(){
      axios.get('http://localhost:5000/location', {params: {theme: this.theme}})
      .then((response) => {
